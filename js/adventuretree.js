        ...
        children: [
            {
                ...
                children: [
                            ...
                            {id: 113,
                             story: "You wake up in the hospital few hours later , your head hurts."
                            }
                          ]
            },
            {
                ...
                option2: "You remember you have flashlight on your phone and you use it",
                option3: "You start to panic , your mind goes blank",
                children: [
                           {id: 121,
                            story: "You just grabbed a lever that pulled you right back onto the surface."
                           }, 
                           {id: 122,
                            story: "You light things around you and see that you are surrounded by underground crab people."
                           }, 
                           {id: 123,
                            story: "You wake up from the horrible dream , you were only sleeping."
                           }
                          ]
            },
            {
                ...
                children: [
                           ...
                           {id: 132,
                            story: "After a while they notice you and capture you for experiments."
                           }, 
                           {id: 133,
...
function choose(option) {
    ...
    var chosennode = root.first(function (node) {
